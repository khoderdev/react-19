    ...
    <>
      ...
      <div className="overflow-x-auto flex flex-col justify-center items-center ">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="">
              ...
              >
                ...
                <option
                  value="Accepted"
                  style={{ color: getStatusColor("Accepted") }}
                >
                  Accepted
                </option>
                <option
                  value="Rejected"
                  style={{ color: getStatusColor("Rejected") }}
                >
                  Rejected
                </option>
                <option
                  value="To be corrected"
                  style={{ color: getStatusColor("To be corrected") }}
                >
                  To be corrected
                </option>
              </select>
        ...
        <Modal isOpen={showConfirmation} onClose={handleCancelDelete}>
          <div className="space-y-4">
            ...
            <div className="flex justify-end">
              ...
              <button onClick={handleCancelDelete} className="!border">
                Cancel
              </button>
            </div>
          </div>
        ...
        <div className="w-full md:w-2/3 items-end flex flex-col">
          <button
            className="btn-main-lg !bg-green-pri hover:!bg-white-bg dark:hover:!bg-black-contents dark:text-black-text !font-medium hover:!text-black-text dark:hover:!text-white-text"
        ...
        <div className="w-full md:w-2/3 overflow-x-auto mt-4">
          <table className="w-full divide-y divide-gray-700">
            <thead className="">
              <tr>
                <th className="px-6 py-3 dark:text-white text-left uppercase tracking-wider">
                  Drug
                </th>
                <th className="px-6 py-3 dark:text-white text-left uppercase tracking-wider">
                  QTY
                ...
                <th className="px-6 py-3 text-red-pri text-left uppercase tracking-wider">
                  Actions
                </th>
              </tr>
            </thead>
                ...
                <tr key={order.id}>
                  ...
                  <td className="px-6 py-3 whitespace-nowrap flex gap-2">
                    <button
                      ...
                      className="btn-bg-green hover:text-black-text dark:hover:text-white-text"
                    >
                      Edit
                    </button>
                    <button
                      onClick={() => handleDeleteOrder(order.id)}
                      className="btn-bordered-red hover:bg-red-pri dark:hover:bg-red-pri bg-white-bg dark:bg-black-bg"
                    >
                      Delete
                    </button>
                  </td>
