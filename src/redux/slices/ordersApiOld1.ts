...
// export const updateOrderOnServer = async (
//   orderId: any,
...
export const addOrderToServer = async (orderData) => {
  try {
    const response = await fetch(`${apiUrl}/create`, {
      ...
      body: JSON.stringify(orderData), // Exclude 'id' from the request body
    });
    const data = await response.json();
    return data;
  } catch (error) {
...
export const updateOrderOnServer = async (orderId, updatedOrderData) => {
  try {
    const response = await fetch(`${apiUrl}/${orderId}`, {
      ...
      body: JSON.stringify(updatedOrderData), // Exclude 'id' from the request body
    });
    const data = await response.json();
    return data;
  } catch (error) {
