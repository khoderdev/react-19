  ...
  return (
    <div className="flex flex-col justify-center items-center">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-6 md:gap-12">
        ...
        <div className="card w-full md:w-96 h-48 justify-start p-4 hover:shadow-green-pri hover:border-green-pri text-center flex-col flex items-center border-2 border-green-sec shadow-md hover:shadow-md hover:transition-all hover:duration-200 rounded-lg overflow-hidden mt-6 md:mt-0">
          <div className="p-4">
            <h2 className="text-xl mb-2 font-bold text-green-pri">Redux</h2>
          </div>
          <div className="flex gap-2 p-4 bg-gray-200">
